    ...
    <div className='container'>
      ...
      <main>
        ...
        <div className='grid'>
          ...
          <a href='/Brooke ' className='card'>
            <h3>Brooke's Page &rarr;</h3>
            <p>Click here to navigate to Brooke's page</p>
          </a>
          <a href='/Michael ' className='card'>
            <h3>Michael Page &rarr;</h3>
            <p>Click here to navigate to the Michael page</p>
          </a>
          <a href='/IsratFelix ' className='card'>
            <h3>Example Israt Page &rarr;</h3>
            <p>Click here to navigate Israt's page...</p>
          </a>
